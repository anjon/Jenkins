        ...
        stage('Tests') {
            parallel {
                ...
                stage('E2E') {
                    ...
                    post {
                        always {
                            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'playwright-report', reportFiles: 'index.html', reportName: 'Playwright-HTML Local', reportTitles: '', useWrapperFileDirectly: true])
                        }
                    }
                }
            }
